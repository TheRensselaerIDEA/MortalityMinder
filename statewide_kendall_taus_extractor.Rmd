...
```{r}
selected_SDs1 <- union(selected_SDs_despair$chr_code, selected_SDs_cancer$chr_code)
selected_SDs1 <- union(selected_SDs, selected_SDs_assault$chr_code)
selected_SDs1 <- union(selected_SDs, selected_SDs_cardiovascular$chr_code)
print(selected_SDs1)
```
