      ...
      tags$div(
        ...
        fluidRow(
          ...
          column(3, 
                 ...
                 HTML("<h5><span style='color:white'>Click <b>BACK</b></span> <b><span style='color:#00f7ff;'>&lt;&lt;</span></b> <span style='color:white'>and <b>NEXT</b> </span>
                           <b><span style='color:#00f7ff;'>&gt;&gt;</span></b> <span style='color:white'>or the left and right arrow keys to move between the</span> <span style='color:white'><b>Nationwide, State</b> and <b>Factor</b> views.</span></h5>"),
                 tags$br(),
                 tags$img(
